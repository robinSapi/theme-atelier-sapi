              ...
              <div class="quick-view-gallery-nav">
                <button type="button" class="gallery-nav-btn gallery-prev" aria-label="Image précédente">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path fill-rule="evenodd" d="M19.4 6.1C15.2 7.6 11.4 11.3 9.7 13.9C8.4 15.9 8.6 17.8 10.1 19C11.8 20.4 14.8 19.4 16.9 17.7C18 16.8 18.8 15.8 19.3 15C19.7 14.3 19 13.7 18.3 14.1C17.1 14.7 15.9 15.2 14.9 15.5C13.1 16 11.9 15.7 11.6 14.9C11.3 14.1 12.2 12.9 13.8 11.3C15.4 9.8 17.4 8.5 19.1 7.7C20 7.3 20.6 7.1 21 7C21.4 6.9 21.6 6.5 21.4 6.2C21.1 5.8 20.4 5.7 19.4 6.1ZM18.2 7.9C15.8 8.9 13.3 11.2 12.0 12.9C11.1 14.1 11 15 11.6 15.5C12.4 16.1 14.1 15.6 15.8 14.8C16.7 14.4 17.5 13.9 18.1 13.4C17.2 13.8 16.3 14.1 15.5 14.3C13.9 14.7 12.7 14.5 12.2 13.6C11.7 12.7 12.6 11.3 14.2 9.7C15.3 8.6 16.6 7.6 17.9 6.9C18.4 6.6 18.8 6.5 19 6.4C18.9 6.8 18.6 7.2 18.2 7.9Z" clip-rule="evenodd"></path>
                  </svg>
                </button>
                ...
                <button type="button" class="gallery-nav-btn gallery-next" aria-label="Image suivante">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path fill-rule="evenodd" d="M4.6 6.1C8.8 7.6 12.6 11.3 14.3 13.9C15.6 15.9 15.4 17.8 13.9 19C12.2 20.4 9.2 19.4 7.1 17.7C6 16.8 5.2 15.8 4.7 15C4.3 14.3 5 13.7 5.7 14.1C6.9 14.7 8.1 15.2 9.1 15.5C10.9 16 12.1 15.7 12.4 14.9C12.7 14.1 11.8 12.9 10.2 11.3C8.6 9.8 6.6 8.5 4.9 7.7C4 7.3 3.4 7.1 3 7C2.6 6.9 2.4 6.5 2.6 6.2C2.9 5.8 3.6 5.7 4.6 6.1ZM5.8 7.9C8.2 8.9 10.7 11.2 12.0 12.9C12.9 14.1 13 15 12.4 15.5C11.6 16.1 9.9 15.6 8.2 14.8C7.3 14.4 6.5 13.9 5.9 13.4C6.8 13.8 7.7 14.1 8.5 14.3C10.1 14.7 11.3 14.5 11.8 13.6C12.3 12.7 11.4 11.3 9.8 9.7C8.7 8.6 7.4 7.6 6.1 6.9C5.6 6.6 5.2 6.5 5 6.4C5.1 6.8 5.4 7.2 5.8 7.9Z" clip-rule="evenodd"></path>
                  </svg>
                </button>
              </div>
