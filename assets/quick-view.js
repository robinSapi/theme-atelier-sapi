              ...
              <div class="quick-view-gallery-nav">
                <button type="button" class="gallery-nav-btn gallery-prev" aria-label="Image précédente">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M16.9 4.7c-2.6 1.2-6.1 4.8-7.9 7.3c-1.4 2-1.8 3.9-1.1 5.4c.6 1.4 2.0 2.1 3.9 2.2c3.2.2 6.4-1.8 7.9-4.7c.5-1-.4-1.9-1.4-1.4c-1.6.8-3.4 1.3-5.0 1.2c-1.0-.1-1.6-.4-1.8-.9c-.3-.7.0-1.7.8-2.9c1.3-1.9 3.7-4.3 5.7-5.6c.9-.6 1.7-1 2.3-1.2c.8-.3 1.1-.9.9-1.5c-.3-.7-1.1-1-2.2-.9c-.7.1-1.5.4-2.0.6Z"></path>
                  </svg>
                </button>
                ...
                <button type="button" class="gallery-nav-btn gallery-next" aria-label="Image suivante">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M7.1 4.7c2.6 1.2 6.1 4.8 7.9 7.3c1.4 2 1.8 3.9 1.1 5.4c-.6 1.4-2.0 2.1-3.9 2.2c-3.2.2-6.4-1.8-7.9-4.7c-.5-1 .4-1.9 1.4-1.4c1.6.8 3.4 1.3 5.0 1.2c1.0-.1 1.6-.4 1.8-.9c.3-.7 0-1.7-.8-2.9c-1.3-1.9-3.7-4.3-5.7-5.6c-.9-.6-1.7-1-2.3-1.2c-.8-.3-1.1-.9-.9-1.5c.3-.7 1.1-1 2.2-.9c.7.1 1.5.4 2.0.6Z"></path>
                  </svg>
                </button>
              </div>
