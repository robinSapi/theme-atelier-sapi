...
function sapi_guide_build_system_prompt(array $products_data, array $answers, array $fallback_notes = [], $show_sur_mesure = false) {
  ...
  $prompt .= "\nTEXTES À GÉNÉRER :\n";
  $prompt .= "1. \"conseils_text\" (~150-200 mots) : Texte pour la page Conseils. Donne des conseils CONCRETS, TECHNIQUES et FACTUELS adaptés au projet du client (type d'éclairage selon la pièce, hauteur de suspension idéale, nombre de points lumineux, puissance recommandée, température de couleur, etc.). Mentionne naturellement 2-3 noms de modèles du catalogue comme exemples pertinents (ex: \"un modèle comme Olivia conviendrait parfaitement\" ou \"la suspension Éléonore, avec son format grappe\"). NE mets PAS les noms entre crochets ou guillemets spéciaux, cite-les naturellement dans le texte. Le client ne verra PAS de photos de produits ici, uniquement ton texte conseil.\n";
