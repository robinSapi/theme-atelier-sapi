...
- **C. Pill Robin V1** ajoutée en tête du `.room-picker-inner` de `page-conseils-eclaires.php` (même avatar que la home `2026/03/Robin-face-avec-Alice-lhelice.jpg`), accroche dédiée **« Mes conseils spéciaux pour ton projet »** (commit `d426872`).
