...
<div class="guide-luminaire-page">
  ...
  <section class="guide-results-section" id="guide-results" aria-hidden="true">
    <div class="guide-results-header">
      <h2 class="guide-results-title" id="guide-results-title">Voici ma proposition <span class="guide-results-signature">&mdash; Robin</span></h2>
      <p class="guide-results-subtitle">Enfin, ce que je vous aurais proposé à l'atelier</p>
    </div>
...
var sapiGuide = <?php echo wp_json_encode([
  ...
  'nonce'        => $ajax_nonce,
  'contactNonce' => wp_create_nonce('sapi-guide-contact'),
  'shopUrl'      => $shop_url,
  'steps'        => $guide_steps,
]); ?>;
</script>
