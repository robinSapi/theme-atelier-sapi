...
<section class="artisan-hero">
  <div class="artisan-hero-inner">
    ...
    <p>L’Atelier Sâpi, c’est surtout le travail de Robin, artisan à tout faire !</p>
  </div>
</section>
...
<section class="artisan-intro">
  <div class="artisan-intro-grid">
    ...
    <div class="artisan-image" style="background-image: url('https://www.atelier-sapi.fr/wp-content/uploads/2025/05/Robin-Sapi-A.jpg');"></div>
  </div>
</section>

<section class="artisan-step">
  <div class="artisan-step-grid">
    <div class="artisan-image" style="background-image: url('https://www.atelier-sapi.fr/wp-content/uploads/2025/05/IMG_1928.png');"></div>
    <div>
...
<section class="artisan-step">
  <div class="artisan-step-grid reverse">
    ...
    <div class="artisan-image" style="background-image: url('https://www.atelier-sapi.fr/wp-content/uploads/2025/05/Retouchee1.jpg');"></div>
  </div>
</section>

<section class="artisan-step">
  <div class="artisan-step-grid">
    <div class="artisan-image" style="background-image: url('https://www.atelier-sapi.fr/wp-content/uploads/2025/05/IMG_7638.jpg');"></div>
    <div>
...
<section class="artisan-step">
  <div class="artisan-step-grid reverse">
    ...
    <div class="artisan-image" style="background-image: url('https://www.atelier-sapi.fr/wp-content/uploads/2025/07/P1130073-scaled.jpg');"></div>
  </div>
</section>

<section class="artisan-quote">
  <blockquote>
    ...
    <span>- Robin, créateur à l'Atelier Sâpi -</span>
  </blockquote>
</section>
