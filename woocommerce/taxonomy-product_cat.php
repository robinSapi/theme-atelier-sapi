...
if ($term_slug === 'suspension') :
  $featured = [
    [
      ...
      'link' => home_url('/nos-creations/timothee-laraignee/'),
    ],
    [
      'id' => 'arthus',
      ...
      'link' => home_url('/nos-creations/arthus-le-lotus/'),
    ],
    [
      'id' => 'olivia',
      ...
      'link' => home_url('/nos-creations/olivia-la-gardiena/'),
    ],
    [
      'id' => 'suze',
      ...
      'link' => home_url('/nos-creations/suze-la-meduse/'),
    ],
    [
      'id' => 'vincent',
      ...
      'link' => home_url('/nos-creations/vincent-lincandescent/'),
    ],
    [
      'id' => 'alban',
      ...
      'link' => home_url('/nos-creations/alban-le-virevoltant/'),
    ],
    [
      'id' => 'irene',
      ...
      'link' => home_url('/nos-creations/irene-la-reine/'),
    ],
    [
      'id' => 'dalida',
      ...
      'link' => home_url('/nos-creations/dalida-le-dahlia/'),
    ],
    [
      'id' => 'gaston',
      ...
      'link' => home_url('/nos-creations/gaston-le-chardon/'),
    ],
  ];
...
elseif ($term_slug === 'lampadaire') :
  $featured = [
    [
      ...
      'link' => home_url('/nos-creations/claudine-la-turbine/'),
    ],
    [
      'id' => 'charlie',
      ...
      'link' => home_url('/nos-creations/charlie-le-pissenlit/'),
    ],
    [
      'id' => 'vincent',
      'title' => "Vincent L'incandescent",
      ...
      'link' => home_url('/nos-creations/vincent-lincandescent-3/'),
    ],
    [
      'id' => 'dalida',
      ...
      'link' => home_url('/nos-creations/dalida-le-dahlia-lamp/'),
    ],
    [
      'id' => 'olivia',
      'title' => 'Olivia La gardiena',
      ...
      'link' => home_url('/nos-creations/olivia-la-gardiena-lamp/'),
    ],
  ];
...
elseif ($term_slug === 'applique') :
  $featured = [
    [
      ...
      'link' => home_url('/nos-creations/charlie-le-pissenlit-2/'),
    ],
    [
      'id' => 'claudine',
      'title' => 'Claudine La turbine',
      ...
      'link' => home_url('/nos-creations/claudine-la-turbine-2/'),
    ],
    [
      'id' => 'olivia',
      'title' => 'Olivia La gardiena',
      ...
      'link' => home_url('/nos-creations/olivia-la-gardiena-2/'),
    ],
    [
      'id' => 'dalida',
      'title' => 'Dalida La dahlia',
      ...
      'link' => home_url('/nos-creations/dalida-le-dahlia-2/'),
    ],
  ];
...
elseif ($term_slug === 'lampe-a-poser') :
  $featured = [
    [
      ...
      'link' => home_url('/nos-creations/bertrand-le-volcan/'),
    ],
    [
      'id' => 'vincent',
      'title' => "Vincent L'incandescent",
      ...
      'link' => home_url('/nos-creations/vincent-lincandescent-2/'),
    ],
  ];
endif;
