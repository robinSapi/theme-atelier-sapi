...
if ($term_slug === 'suspension') :
  $featured = [
    [
      ...
      'link' => '/nos-creations/timothee-laraignee/',
    ],
    [
      'id' => 'arthus',
      ...
      'link' => '/nos-creations/arthus-le-lotus/',
    ],
    [
      'id' => 'olivia',
      ...
      'link' => '/nos-creations/olivia-la-gardiena/',
    ],
    [
      'id' => 'suze',
      ...
      'link' => '/nos-creations/suze-la-meduse/',
    ],
    [
      'id' => 'vincent',
      ...
      'link' => '/nos-creations/vincent-lincandescent/',
    ],
    [
      'id' => 'alban',
      ...
      'link' => '/nos-creations/alban-le-virevoltant/',
    ],
    [
      'id' => 'irene',
      ...
      'link' => '/nos-creations/irene-la-reine/',
    ],
    [
      'id' => 'dalida',
      ...
      'link' => '/nos-creations/dalida-le-dahlia/',
    ],
    [
      'id' => 'gaston',
      ...
      'link' => '/nos-creations/gaston-le-chardon/',
    ],
  ];
...
elseif ($term_slug === 'lampadaire') :
  $featured = [
    [
      ...
      'link' => '/nos-creations/claudine-la-turbine/',
    ],
    [
      'id' => 'charlie',
      ...
      'link' => '/nos-creations/charlie-le-pissenlit/',
    ],
    [
      'id' => 'vincent',
      'title' => "Vincent L'incandescent",
      ...
      'link' => '/nos-creations/vincent-lincandescent-3/',
    ],
    [
      'id' => 'dalida',
      ...
      'link' => '/nos-creations/dalida-le-dahlia-lamp/',
    ],
    [
      'id' => 'olivia',
      'title' => 'Olivia La gardiena',
      ...
      'link' => '/nos-creations/olivia-la-gardiena-lamp/',
    ],
  ];
...
elseif ($term_slug === 'applique') :
  $featured = [
    [
      ...
      'link' => '/nos-creations/charlie-le-pissenlit-2/',
    ],
    [
      'id' => 'claudine',
      'title' => 'Claudine La turbine',
      ...
      'link' => '/nos-creations/claudine-la-turbine-2/',
    ],
    [
      'id' => 'olivia',
      'title' => 'Olivia La gardiena',
      ...
      'link' => '/nos-creations/olivia-la-gardiena-2/',
    ],
    [
      'id' => 'dalida',
      'title' => 'Dalida La dahlia',
      ...
      'link' => '/nos-creations/dalida-le-dahlia-2/',
    ],
  ];
...
elseif ($term_slug === 'lampe-a-poser') :
  $featured = [
    [
      ...
      'link' => '/nos-creations/bertrand-le-volcan/',
    ],
    [
      'id' => 'vincent',
      'title' => "Vincent L'incandescent",
      ...
      'link' => '/nos-creations/vincent-lincandescent-2/',
    ],
  ];
endif;
