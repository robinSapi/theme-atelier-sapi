...
(function() {
  ...
  // ═══════════════════════════════════════════════════════════════
  // MODAL ZOOM WITH ZOOM-ON-HOVER (Desktop only)
  // ═══════════════════════════════════════════════════════════════
  const galleryZoom = document.querySelector('.gallery-zoom');

  if (galleryZoom && window.innerWidth > 768) {
    ...
    // Open modal on gallery zoom click
    galleryZoom.addEventListener('click', function(e) {
      e.preventDefault();
    ...
    modalContainer.addEventListener('mousemove', function(e) {
      ...
      // Apply transform to zoom at cursor position
