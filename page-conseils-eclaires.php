...
<section class="advice-section-block">
  ...
  <div class="advice-image" style="background-image: url('<?php echo esc_url(home_url("/wp-content/uploads/")); ?>2025/03/sapi__deco_fonction_1.jpg');"></div>
</section>

<section class="advice-section-block">
  <div class="advice-image" style="background-image: url('<?php echo esc_url(home_url("/wp-content/uploads/")); ?>2025/07/IMG_9065.jpeg');"></div>
  <div class="advice-block">
...
<section class="advice-section-block">
  <div class="advice-block">
    ...
    <p class="advice-intro">Voici nos astuces pour éviter un faux pas lumineux.</p>
    <div class="advice-card">
  ...
  <div class="advice-image" style="background-image: url('<?php echo esc_url(home_url("/wp-content/uploads/")); ?>2025/03/sapi__dimension_3.jpg');"></div>
</section>

<section class="advice-section-block">
  <div class="advice-image" style="background-image: url('<?php echo esc_url(home_url("/wp-content/uploads/")); ?>2025/07/Claudine.jpg');"></div>
  <div class="advice-block">
...
<section class="advice-outro">
  <p>Éclairer une pièce, c’est un peu comme choisir la bonne sauce pour ses pâtes : tout est une question et préférence et de dosage !</p>
</section>
